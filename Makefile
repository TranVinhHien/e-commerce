...
mountimg:
	sudo mount -t cifs //172.16.21.145/images_attr /home/master/project/e-commerce/imgs/products/images_attr   -o username=admin,password=Hienlazada#1,vers=3.0
	sudo mount -t cifs //172.16.21.145/images_customer  /home/master/project/e-commerce/imgs/avatar   -o username=admin,password=Hienlazada#1,vers=3.0
	sudo mount -t cifs //172.16.21.145/images  /home/master/project/e-commerce/imgs/products/images   -o username=admin,password=Hienlazada#1,vers=3.0 
